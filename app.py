...
# ============================================================
# BIG PICTURE MARKET PULSE (Manual Inputs)
# ============================================================
...
def render_market_pulse(mi: dict):
    st.markdown('<div class="section-title">Big Picture Market Pulse</div>', unsafe_allow_html=True)
...
def render_composite_section(mi: dict):
    st.markdown('<div class="section-title">Composite Model</div>', unsafe_allow_html=True)
...
# Build the full pull list (ETFs + STOCKS + BENCHMARK)
...
# ============================================================
# Big Picture Market Pulse (below RS)
# ============================================================
